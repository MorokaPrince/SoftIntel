...
💬 This inquiry was sent from the NovaTek Resources page`;
  ...
  const handleWhatsAppContact = () => {
    const message = `💬 Hi! I'd like to CONTACT NovaTek for more information.
...
💬 I'm interested in learning more about NovaTek services!
